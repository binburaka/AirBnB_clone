...
This is a team project under the ALX Software Engineering Programme with the task of building a clone of [AirBnB](https://www.airbnb.com/).

The console is a command-line interpreter which will be used create, retrieve, manage objects and carry out different operations on the objects.

### Storage

Classes created are handled by a File storage engine implemented with the `FileStorage` Class.
